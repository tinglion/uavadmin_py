...
from uavadmin.system.models import FileList
from uavadmin.utils.json_response import DetailResponse
...
class FileSerializer(CustomModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if file_engine == 'oss':
            from uavadmin_cloud_storage.views.aliyun import ali_oss_upload
            ...
            from uavadmin_cloud_storage.views.tencent import tencent_cos_upload
