...
from uavadmin.dataset.models import DsPatient
from uavadmin.dataset.serializers import DsPatientSerializer
...
class DsPatientViewSet(CustomModelViewSet):
    """
    不良反应药品接口
    list:查询
    create:新增
    ...
    queryset = DsPatient.objects.all()
    serializer_class = DsPatientSerializer
