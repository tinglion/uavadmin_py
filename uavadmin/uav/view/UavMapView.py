...
from uavadmin.uav.models import UavMap
from uavadmin.uav.serializers import UavMapSerializer
...
class UavMapViewSet(CustomModelViewSet):
    """
    不良反应药品接口
    list:查询
    create:新增
    ...
    queryset = UavMap.objects.all()
    serializer_class = UavMapSerializer
