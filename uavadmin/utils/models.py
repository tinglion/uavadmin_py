...
class SoftDeleteModel(models.Model):
    ...
    is_deleted = models.BooleanField(
        verbose_name="是否软删除", help_text="是否软删除", default=False, db_index=True
    )
...
class CoreModel(models.Model):
    ...
    description = models.CharField(
        max_length=255, verbose_name="描述", null=True, blank=True, help_text="描述"
    )
...
class CoreModelLcmed(models.Model):
    id = models.BigAutoField(primary_key=True, help_text="Id", verbose_name="Id")
...
def get_model_from_app(app_name):
    ...
    filter_model = [
        ...
        if item != "CoreModel"
        and issubclass(getattr(model_module, item).__class__, models.base.ModelBase)
    ]
    model_list = []
