...
一般来说，国外的一些地图，都是采用WGS84坐标系，比如谷歌地图、OMS地图、Bing地图（非中国区域）等。而国内的地图，处于保密需求，大多采用火星坐标系，在WGS84的基础上作了一些偏移，如高德地图、腾讯地图等。而百度又在火星坐标系的基础上又作了一定偏移，生成了自己的百度坐标系。
"""
...
if __name__ == '__main__':
    ...
    print(f"WGS84坐标系->火星坐标系 ({lng}, {lat})=>{result3}")
