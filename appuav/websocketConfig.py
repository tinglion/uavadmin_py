...
from appuav import settings
from uavadmin.system.models import MessageCenter, Users, MessageCenterTargetUser
from uavadmin.system.views.message_center import MessageCenterTargetUserSerializer
...
def _get_message_center_instance(message_id):
    from uavadmin.system.models import MessageCenter
...
def _get_message_unread(user_id):
    """获取用户的未读消息数量"""
    from uavadmin.system.models import MessageCenterTargetUser
