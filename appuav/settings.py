...
MIDDLEWARE = [
    "uavadmin.utils.middleware.HealthCheckMiddleware",
    ...
    "uavadmin.utils.middleware.ApiLoggingMiddleware",
]

ROOT_URLCONF = "appuav.urls"
...
WSGI_APPLICATION = "appuav.wsgi.appuav"
...
DATABASE_ROUTERS = ["appuav.dbrouter.DbRouter"]
...
# ********************* channels配置 ******************* #
# ===================================================== #
ASGI_APPLICATION = "appuav.asgi.appuav"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_FILTER_BACKENDS": (
        ...
        "uavadmin.utils.filters.CustomDjangoFilterBackend",
        "rest_framework.filters.SearchFilter",
        "rest_framework.filters.OrderingFilter",
    ),
    "DEFAULT_PAGINATION_CLASS": "uavadmin.utils.pagination.CustomPagination",  # 自定义分页
    ...
    "EXCEPTION_HANDLER": "uavadmin.utils.exception.CustomExceptionHandler",  # 自定义的异常处理
}
# ================================================= #
# ******************** 登录方式配置 ******************** #
# ================================================= #

AUTHENTICATION_BACKENDS = ["uavadmin.utils.backends.CustomBackend"]
# ================================================= #
# ****************** simplejwt配置 ***************** #
# ================================================= #
SIMPLE_JWT = {
...
SWAGGER_SETTINGS = {
    ...
    "DEFAULT_AUTO_SCHEMA_CLASS": "uavadmin.utils.swagger.CustomSwaggerAutoSchema",
}
...
# 任务限流
CELERY_TASK_ANNOTATIONS = {"tasks.test_add": {"rate_limit": "10/s"}}
# Worker并发数量，一般默认CPU核数，可以不设置
#  CELERY_WORKER_CONCURRENCY = 2
# 使用 gevent 作为并发池
CELERYD_POOL = "gevent"
CELERY_EVENT_LOOP = "asyncio"
...
# ********** 一键导入插件配置开始 **********
# 例如:
# from uavadmin_upgrade_center.settings import *    # 升级中心
# from uavadmin_celery.settings import *            # celery 异步任务
# from uavadmin_third.settings import *            # 第三方用户管理
# from uavadmin_ak_sk.settings import *            # 秘钥管理管理
# from uavadmin_tenants.settings import *            # 租户管理
# from uavadmin_social_auth.settings import *
# ...
# ********** 一键导入插件配置结束 **********

OSS_CONF = locals().get("OSS_CONF", "")
DATA_UPLOAD_MAX_NUMBER_FIELDS = 1024
DATA_UPLOAD_MAX_MEMORY_SIZE = 128 * 1024 * 1024

OPENAI_CONF = locals().get("OPENAI_CONF", "")
